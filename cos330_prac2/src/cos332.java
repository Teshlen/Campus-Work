...
//        bod += "</body>";
   ...
   // }
    ...
    public String choices1() {
        ...
        choice += input("enter your name to log on", "name1");
...
//        choice += "Log on? enter 4";
    ...
    public String extract(String mes) {
        ...
        int index1 = 0;
        int index2 = 0;
        index1 = mes.indexOf("=") + 1;
        index2 = mes.indexOf(" H");
//        
//        for (int y = 0; y < mes.length()-1 ; y++) {
//            if (x.charAt(y) == '=') {
//                index1 = y + 1;
//            }
//
...
//        }
        ...
        return mes.substring(index1, index2);
    }
    ...
    public Boolean checkCredentials(String _name, String _password)
    {   String n = _name;
        String pass = _password;
        System.out.println("-------------" + n);
               
        x = db.findUserByNameAndPassword(n, pass);
...
//        }
        ...
        if (mes.contains("Password=")) {
           
            password = mes;
            password = extract(password);
            System.out.println("sucess on Password" + password+ "dsfdddf");
    ...
    public String input(String x, String n) {
        ...
        bod += "<form action = \""+rand.nextGaussian() + rand.nextGaussian() + rand.nextGaussian() + rand.nextGaussian() + rand.nextGaussian() + rand.nextGaussian() +  rand.nextGaussian() + rand.nextGaussian() + rand.nextGaussian()  + rand.nextGaussian() + rand.nextGaussian() + rand.nextGaussian() + "\" method=\"get\"> "+" <p>";
        bod += "Input:<input type=\"text\"  name=\"" + n + "\" size=\"50\">";
        bod += "<input type=\"submit\" value=\"submit\" onclick = \"localhost:55555\" VALUE = \"refresh\">";
        bod += "</p></form> ";
        bod += "";
       // bod += "</body>";
        return bod;
